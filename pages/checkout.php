...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $processed_by_user_id = $_POST['processed_by_user_id'] ?? null;
  $copy_ids_input = $_POST['copy_ids'] ?? '';
  $li_duedate = $_POST['li_duedate'] ?? null;
  ...
  <div class="row g-3">
    <div class="col-12 col-lg-7">
      <div class="card p-4">
        ...
        <p class="text-muted mb-4">Create a Loan + LoanItems. Processor is required.</p>
        ...
        <form action="checkout.php" method="POST">
          <div class="row g-3">
            <div class="col-12 col-md-6">
              ...
              <select class="form-select" name="borrower_id" required>
                ...
                <?php foreach ($activeBorrowers as $borrower): ?>
                  <option value="<?php echo htmlspecialchars($borrower['borrower_id']); ?>">
                    <?php echo htmlspecialchars($borrower['borrower_name']); ?>
                  </option>
                <?php endforeach; ?>
              </select>
            </div>
            ...
            <div class="col-12 col-md-6">
              ...
              <div class="text-muted small mt-1">Should be the logged-in ADMIN user_id.</div>
            </div>
            ...
            <div class="col-12">
              ...
              <div class="text-muted small mt-1">Validate copy status is AVAILABLE and not currently on loan.</div>
            </div>
          ...
          <table class="table table-sm mb-0">
            ...
            <tbody>
              ...
              <?php if (empty($availableCopies)): ?>
                <tr>
                  <td colspan="2" class="text-center text-muted small">No copies available</td>
                </tr>
              <?php endif; ?>
            </tbody>
          </table>
