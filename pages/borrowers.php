            ...
            <form action="#" method="POST">
              <div class="row g-2">
                ...
                <div class="col-12">
                  ...
                  <input class="form-control" name="borrower_phone" placeholder="09xxxxxxxxx" required>
                </div>
                <div class="col-12 col-md-6">
              ...
              <button class="btn btn-primary w-100 mt-3" type="submit" name="add_borrower">Create Borrower Account</button>
            </form>
          </div>
        </div>
